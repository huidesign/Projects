...
//-----------------------------------------------------------------
extern int tmpLock;
bool HwFederateAmbassador::needLock = false;
...
void HwFederateAmbassador::setDlgPoint(CHLA_HIT_CHATDlg *plg)
{
	m_pdlg = plg;
}
...
void HwFederateAmbassador::discoverObjectInstance(	
	...
	RTI::FederateInternalError) {
		m_pdlg->DiscoverRegBall(theObjectName);
}
