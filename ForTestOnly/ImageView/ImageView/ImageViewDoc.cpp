...
void CImageViewDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CImageViewDoc::InitializeSearchContent()
{
...
void CImageViewDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
