#ifndef FgFederateAmbassador_h
#define FgFederateAmbassador_h
...
//
//-----------------------------------------------------------------
class FgFederateAmbassador : public RTI::FederateAmbassador
{
public:

FgFederateAmbassador();
virtual ~FgFederateAmbassador() throw(RTI::FederateInternalError);
